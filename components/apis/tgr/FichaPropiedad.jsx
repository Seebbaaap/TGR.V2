...
export default function FichaPropiedad({ remate, analisis, errorAnalisis, rolFormato }) {
    ...
    return (
        ...
        <div style={{ background: "var(--surface)", border: "1px solid var(--border)", borderRadius: "12px", padding: "16px", minHeight: "200px", display: "flex", flexDirection: "column", gap: "8px" }}>
            ...
            {analisis?.coordenadas ? (
                <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                    <p style={{ fontSize: "0.72rem", color: "var(--text-muted)" }}>Coordenadas disponibles — mapa pendiente de integración.</p>
                    <Campo label="Latitud"  valor={String(analisis.coordenadas.lat)} />
                    <Campo label="Longitud" valor={String(analisis.coordenadas.lon)} />
                </div>
            ) : (
                <p style={{ fontSize: "0.72rem", color: "var(--text-muted)" }}>Sin coordenadas disponibles.</p>
            )}
        </div>
    </div>    
